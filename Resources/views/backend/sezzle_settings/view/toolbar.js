// {namespace name="backend/sezzle_settings/toolbar"}
// {block name="backend/sezzle_settings/toolbar"}
Ext.define('Shopware.apps.SezzleSettings.view.Toolbar', {
    extend: 'Ext.toolbar.Toolbar',
    alias: 'widget.sezzle-settings-toolbar',
